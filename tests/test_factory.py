...
def test_docomo1():
    ...
    device = factory.create({'HTTP_USER_AGENT': 'DoCoMo/2.0 P01A(c100;TB;W24H15)'})
...
def test_docomo2():
    factory = DoCoMoUserAgentFactory()
    device = factory.create({'HTTP_USER_AGENT': 'DoCoMo/2.0 P703i(c100;TB;W24H12;ser0123456789abcdf;icc01234567890123456789)'})
...
def test_ezweb1():
    ...
    device = factory.create({'HTTP_USER_AGENT': 'KDDI-TS2A UP.Browser/6.2.0.9 (GUI) MMP/2.0'})
...
def test_softbank_3g():
    ...
    device = factory.create({'HTTP_USER_AGENT': 'SoftBank/1.0/913SH/SHJ001 Browser/NetFront/3.4 Profile/MIDP-2.0 Configuration/CLDC-1.1'})
...
def test_willcom():
    ...
    device = factory.create({'HTTP_USER_AGENT': 'Mozilla/3.0(WILLCOM;SANYO/WX310SA/2;1/1/C128) NetFront/3.3,61.198.142.127'})
